...
- End-to-end real Codex Wander smoke covering candidate synthesis, independent review, persisted Runtime proof and shutdown.
...
- Runtime failures retain a bounded diagnostic message for operational debugging without exposing it in the public response.
